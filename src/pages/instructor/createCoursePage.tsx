...
import { createCourseData, createLessonData, createModuleData } from "@/utils/course"
import ProgressLoaderModal from "@/components/instructor/create-course/progress-loader"
...
const markLastStep = (status: ProgressStep["status"]) => {
  ...
  const publishCourse = async (publish: PublishSchemaType) => {
    setShowProgress(true);
    setProgressSteps([]);
    try {
      setIsSubmitting(true)
      updateStep("Creating course...");
      const courseData = createCourseData(basicInformation,advancedInformation,publish)
