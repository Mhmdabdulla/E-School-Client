...
import { advancedInformationSchema, type AdvancedInformationSchemaType } from "@/schemas/course/advanced-information.schema"



interface AdvancedInformationFormProps {
  defaultValues?: Partial<AdvancedInformationSchemaType>
  onSubmit: (data: AdvancedInformationSchemaType) => void
  onBack: () => void
}
...
const AdvancedInformation = ({ defaultValues, onSubmit, onBack }: AdvancedInformationFormProps) => {
  ...
  const form = useForm<AdvancedInformationSchemaType>({
