...
import {curriculumSchema, type CurriculumSchemaType } from "@/schemas/course";



interface CurriculumFormProps {
  defaultValues?: Partial<CurriculumSchemaType>;
  onSubmit: (data: CurriculumSchemaType) => void;
  onBack: () => void;
}
