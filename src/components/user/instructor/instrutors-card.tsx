...
export function InstructorCard({ instructor }: InstructorCardProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col border rounded-lg p-4 shadow-sm transition hover:shadow-md"
      )}
    >
      ...
      <Button
        ...
        variant="outline"
        size={"sm"}
        className=" mt-auto flex justify-evenly gap-4 text-sm"
      >
        Connect
