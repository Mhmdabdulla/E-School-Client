  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md sm:max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="mt-4 space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              {application.preferredSubjects.map((subject:string,index:number) => (
            ...
            <div>
              ...
              {application.teachingLanguages.map((language:string,index:number) => (
        ...
        <DialogFooter className="flex flex-col-reverse gap-2 sm:flex-row mt-4">
